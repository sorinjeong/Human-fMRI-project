function [sbj_perform, sbj_info, figs] = func_bhv_performance_plots(n_sbj, is_save_output, all_sbj_events, sbj_info_file)
...
x_values = 0:2:(length(x_mean)*2-1);
plot(x_values, x_mean,'k-o', 'LineWidth',2);
title('Change in Average Accuracy over Adjacent Trials','FontSize',14,'FontWeight','bold')
xlabel('Trial')
ylabel('Accuracy')
