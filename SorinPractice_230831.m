...
%save
% 
% saveas(gcf,['D:\leelab\Human fMRI projects\MATLAB\23.08.29_LearningCurve\Figures_ver2\' Session],'png');
% hold off; close

end

% % Create a table containing all cdata values for each session
% cdata_table = array2table(cdata_table, 'VariableNames', {'cdata'}, 'RowNames', Subjects);
