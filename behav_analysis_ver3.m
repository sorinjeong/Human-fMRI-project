...
T=addvars(T,repelem(SubInfoFile.PASS(:),32),combi,repmat([1;2;3;4],144,1),repmat([1;2;1;2],144,1),'NewVariableNames',{'PASS','Combi','StopPoint','1324'});
...
for i = 1:length(figs)
    saveas(figs(i), ['D:\internship\Human fMRI analysis\소린 목요일 미팅자료\230725 Joint meeting\figure\' num2str(i) '.png']);
end

% writetable(abs(SubInfoFile),'sorin_ver3_SubInfoFile.csv')