...
addpath('C:\spm\spm12');
addpath('C:\spm\spm12\external\fieldtrip'); % Add the FieldTrip directory back to the MATLAB path.
ft_defaults; % Reset the FieldTrip defaults.

addpath(genpath('D:\leelab\Human fMRI projects\0O-CAT\fMRI_ocat_data'));
