...
NumOfSubs = 31;
ParsingVersion = num2str(231115);

% %% subject numbering , folder root
% for subname = 1:NumOfSubs
%     Subjects{subname} = strcat("sub-",num2str(subname, '%02.f'));
% end
Subjects={"sub-01","sub-02","sub-03","sub-04","sub-05","sub-06","sub-07","sub-08","sub-09","sub-10","sub-11","sub-12","sub-13","sub-14","sub-15","sub-16","sub-17","sub-18","sub-19","sub-20","sub-21.1","sub-21.2","sub-22","sub-23","sub-24","sub-25","sub-26","sub-27","sub-28","sub-29","sub-30","sub-31"};

cd('Z:\E-Phys Analysis\fMRI_ocat\OCAT_BHV\')
...
for fi = 1:numel(Subjects)
    ...
    Root = ['Z:\E-Phys Analysis\fMRI_ocat\OCAT_BHV\'];
